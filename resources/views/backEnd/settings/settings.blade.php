                    ...
                    <div class="tab-pane {{  ( Session::get('active_tab') == 'styleTab') ? 'active' : '' }}" id="tab-5">
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <div class="form-group row">
                                @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                    <div class="col-sm-6">
                                        <label for="style_logo_vi">{!!  trans('backLang.siteLogo') !!} @if(Helper::GeneralWebmasterSettings("vi_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.vietnamBox') !!}@endif</label>
