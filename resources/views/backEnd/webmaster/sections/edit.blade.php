                                        ...
                                        <div id="options"
                                            ...
                                            @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                                <div class="col-sm-3 col-xs-5">
                                                    ...
                                                    {!! Form::textarea('details_vi',Session::get('WebmasterSectionField')->details_ar, array('placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.rtl'),'rows'=>'12','style'=>'white-space: nowrap;')) !!}
                                                    <small>
                                                        <i class="material-icons">&#xe8fd;</i> {!!  trans('backLang.customFieldsOptionsHelp') !!}
                                                    </small>
                                                </div>
