                ...
                <div class="tab-content pos-rlt">
                    ...
                    <div class="tab-pane {{  ( Session::get('active_tab') == 'languageSettingsTab') ? 'active' : '' }}"
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <div class="form-group">
                                <label>{{ trans('backLang.vietnameseLanguageFields') }} : </label>
                                <div class="radio">
                                    <div>
                                        <label class="ui-check ui-check-md">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <div>
                                        <label class="ui-check ui-check-md">
                                            {!! Form::checkbox('languages_vi_status','1',($WebmasterSetting->languages_vi_status == 1)? true : false , array('id' => 'languages_vi_status','class'=>'has-value')) !!}
                                            <i class="dark-white"></i>
                                            {!!  trans('backLang.vietnamBox') !!}
                                        </label>
                                    </div>
                                    <div style="margin-top: 5px;">
                                        <label class="ui-check ui-check-md">
                            ...
                            <a class="btn info " target="_blank"
                               href="{{ url(env('BACKEND_PATH','admin').'/webmaster/translations') }}">
                            ...
                            <div class="form-group m-t">
                                ...
                                <div>
                                    <select name="languages_by_default" class="form-control c-select">
                                        <option value="vi" {{ ($WebmasterSetting->languages_by_default=="vi")?"selected='selected'":"" }}>{{ strip_tags(trans('backLang.vietnamBox')) }}</option>
