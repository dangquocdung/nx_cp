    ...
    <div class="padding">
                            ...
                            <div class="form-group row">
                                <label for="title_vi"
                                       class="col-sm-2 form-control-label">
                                        @if($WebmasterSection->ava_status)
                                            {!!  trans('backLang.topicName') !!}
                                        @else
                                            {!!  trans('backLang.noi-dung') !!}
                                        @endif
                                    @if(Helper::GeneralWebmasterSettings("vi_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.vietnamBox') !!}@endif
                                </label>
                                <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="box p-a-xs">
                                                {!! Form::textarea('details_vi',$Topics->details_vi, array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control summernote_vi', 'dir'=>trans('backLang.rtl'),'ui-options'=>'{height: 300,callbacks: {
        ...
        onImageUpload: function(files, editor, welEditable) {
            sendFile(files[0], editor, welEditable,1);
                        ...
                        @if( !in_array( $WebmasterSection->id ,[49,51]))
                            ...
                            <div class="form-group row">
                                <label for="link_status"
                                        class="col-sm-2 form-control-label">Tiêu điểm</label>
                                <div class="col-sm-10">
                                    <div class="radio">
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('thongbao','1',($Topics->thongbao==1) ? true : false, array('id' => 'status1','class'=>'has-value')) !!}
                                            <i class="dark-white"></i>
                                            {{ trans('backLang.yes') }}
                                        </label>
                                        &nbsp; &nbsp;
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('thongbao','0', ($Topics->thongbao==0) ? true : false, array('id' => 'status2','class'=>'has-value')) !!}
                                            <i class="dark-white"></i>
                                            {{ trans('backLang.no') }}
                                        </label>
                                    </div>
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("vi_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                @if(Helper::GeneralWebmasterSettings("vi_box_status") && Helper::GeneralWebmasterSettings("en_box_status"))
                                                    <small>{!!  trans('backLang.vietnamBox') !!}</small> @endif
            ...
            $.ajax({
                ...
                success: function(url) {
                    ...
                    if(lang==1) {
                        ...
                        $('.summernote_vi').summernote("insertNode", image[0]);
                    }
                }
            });
        }
