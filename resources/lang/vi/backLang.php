...
return array (
  ...
  'sectionFather' => 'Mục cha',
  'sectionNoFather' => 'Mục cha',
  'size' => 'Kích thước',
  'width' => 'Width',
  'height' => 'Chiều cao',
  ...
  'hinh-anh' => 'Hình ảnh',
  'diem-bao' => 'Điểm báo',
  'phat-thanh' => 'Phát thanh',
  'tai-lieu-truyen-thong' => 'Tài liệu truyền thông',
  'tin-ha-tinh' => 'Tin Hà Tĩnh',
  ...
  'san-pham' => 'Sản phẩm',
  'trang-rieng' => 'Trang riêng',
  'tin-tuc-su-kien' => 'Tin tức, Sự kiện',
  'truyen-hinh' => 'Truyền hình',
  'xay-dung-nong-thon-moi' => 'Xây dựng nông thôn mới',
  'van-hoa-xa-hoi' => 'Văn hóa, Xã hội',
  'tuyen-truyen-phap-luat' => 'Phổ biến, tuyên truyền pháp luật',
  'the-thao-giai-tri' => 'Thể thao, Giải trí',
  'kinh-te-dau-tu' => 'Kinh tế, Đầu tư',
  'chinh-tri' => 'Chính trị',
  'chuyen-muc' => 'Chuyên mục',
  'cai-cach-hanh-chinh' => 'Cải cách hành chính',
  'an-ninh-quoc-phong' => 'An ninh, Quốc phòng',
  'mailSettings' => 'Cài đặt email',
  'googleRecaptcha' => 'Google reCAPTCHA',
  'googleTags' => 'Google tags',
  'restfulAPI' => 'Restful API',
  'cong-khai-minh-bach-thong-tin' => 'Công khai minh bạch thông tin',
  'tam-long-nhan-ai' => 'Tấm lòng nhân ái',
  'van-ban' => 'Văn bản',
  'googleRecaptchaSitekey' => 'Google reCAPTCHA site key',
  'googleRecaptchaSecret' => 'Google reCAPTCHA secret key',
  'googleRecaptchaStatus' => 'Trạng thái',
  'ban-doc-hoi' => 'Bạn đọc hỏi',
);
