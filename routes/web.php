...
Route::group(['prefix' => 'admin', 'middleware' => 'fw-block-blacklisted'], function () {
...
//Lich cong tac
// Route::get('/lich-cong-tac-tuan/{ngay?}', 'FrontendHomeController@lichCongTac')->name('lich-cong-tac-tuan');

Route::get('lich-cong-tac', function(){

    return view('nx.lich-ivinh');

});

Route::get('lich-cong-tac-tuan', function(){

    return view('nx.lich-ivinh-w');

});

//Ban doc hoi
Route::get('/ban-doc-hoi-co-quan-chuc-nang-tra-loi','FrontendHomeController@banDocHoi')->name('ban-doc-hoi');
